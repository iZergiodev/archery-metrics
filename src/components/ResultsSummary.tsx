...
export function ResultsSummary({
  ...
  return (
    <section className="border-b border-[var(--border)] pb-6">
      ...
      {result.matchIndex != null && (
        <div className="mt-6 rounded-[14px] border border-[var(--border)] bg-[var(--bg-surface)] px-4 py-4">
          ...
          <div className="mt-4">
            ...
            <div className="relative h-3 overflow-hidden rounded-full bg-[var(--border)]">
              ...
              <div
                className="absolute -top-1 h-5 w-[3px] rounded-full bg-[var(--text-primary)] transition-all duration-300"
                style={{
                  left: `${Math.max(2, Math.min(98, getMatchIndexPosition(result.matchIndex)))}%`,
                  boxShadow: '0 0 0 2px rgba(11,11,11,0.9)',
                }}
              />
            </div>
